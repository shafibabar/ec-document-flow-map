'use strict';
/* Test fixture — a legal two-sided conflict */
  ...
  return {
    ...
    edges: [
      { from: "a", to: "fixture", transport: "kafka", name: "t.one",
        eventType: { conflict: [ { value: "EvA", source: { file: "Echo Engine/EVENT_FLOW_MAP.md", heading: "Events Consumed" } }, { value: "EvB", source: { file: "Echo Engine/EVENT_FLOW_MAP.md", heading: "Events Consumed" } } ] }, direction: "in", source: { file: "Echo Engine/EVENT_FLOW_MAP.md", heading: "Events Consumed" } }
    ],

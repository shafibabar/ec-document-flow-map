'use strict';
/* TEST FIXTURE — indexer stripped of name, kind, group and generation.
   docs/MODEL_SCHEMA.md marks all four Required; the validator once treated
   absence as permission. Built from data/layout.js by deleting the four keys
   in Node and re-emitting, never by editing the generated text. */

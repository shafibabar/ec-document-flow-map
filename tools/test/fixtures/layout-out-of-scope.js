'use strict';
/*
 * TEST FIXTURE — includes a 2.0 component
 *
...
(function (root, factory) {
  ...
  return {
    ...
    nodes: [
    { id: 'ingestor-service', name: 'Ingestor Service', kind: 'service',
      grid: { x: 6, y: 5 },
      group: 'none', generation: '3.0',
      source: { file: IMG, heading: 'lower middle' } },

'use strict';
/*
 * centralised-audit loses its px; store:EA-S3's px is moved outside the image.
 * 
 * px is the only machine-checkable evidence in the file and the validator did not
 * mention it: it could be deleted from all 21 nodes for a clean run, which would
 * also have silently disabled the rank check above.
 *

'use strict';
/* TEST FIXTURE — manual-run moved to (12, 5), to the RIGHT of Gateway, while
   its source.reason still reads "placed upstream-left of Gateway". The entry
   looks fully sourced and contradicts itself. Built from data/layout.js in Node. */

'use strict';
/* TEST FIXTURE — grid coordinates that are not integers
   Built from data/layout.js so everything except the seeded fault stays valid. */
(function (r, f) { var d = f(); if (typeof module === 'object' && module.exports) module.exports = d; else r.EC_LAYOUT = d; })

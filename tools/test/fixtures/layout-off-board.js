'use strict';
/* TEST FIXTURE — one node at a negative rank, one far outside the declared
   board. store:EC-S3 moves to x=-1 and alerting to (99, 42), so the declared
   13x8 no longer describes the nodes. Built from data/layout.js in Node. */

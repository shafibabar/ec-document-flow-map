'use strict';
/*
 * alerting and echo-engine swap grid cells, px untouched.
 * 
 * Two boxes 1738px apart on the image, inverted. Before review cycle 2 of #5 this
 * validated clean and all fifty tests stayed green: ORDERED_CHAINS pinned eight
 * nodes and the other thirteen had their relative order checked by nothing, while
 * acceptance criterion 4 of #5 is that left-to-right order matches the image.
 *

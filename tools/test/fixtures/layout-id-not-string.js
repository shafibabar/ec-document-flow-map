'use strict';
/*
 * gateway's id is the number 12345.
 * 
 * `if (!n.id)` admits it, and the prefix/kind cross-check added in cycle 1 called
 * n.id.startsWith on it: an uncaught TypeError that printed no diagnostic for any
 * of the 21 nodes, in a validator whose header promises to print every problem —
 * and exited 1, the same code as a clean rejection.
 *

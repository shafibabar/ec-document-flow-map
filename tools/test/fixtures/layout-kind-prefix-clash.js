'use strict';
/* TEST FIXTURE — external:archive declared kind 'store', and the store node
   store:review.v1 declared kind 'external'. The id prefix and the kind are two
   statements of the same fact; a node that joins to an extract by id and then
   disagrees with it about what the thing is. Built from data/layout.js in Node. */

'use strict';
/* Test fixture — jdbc smuggled through a conflict wrapper */
(function (root, factory) {
  ...
  return {
    ...
    nodes: [], edges: [
      { from: "a", to: "fixture", name: "t.one", eventType: "Ev", direction: "in",
        transport: { conflict: [ { value: "jdbc", source: S }, { value: "kafka", source: S } ] },
        source: S }
    ],

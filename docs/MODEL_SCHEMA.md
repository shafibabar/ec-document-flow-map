...
reporting 111 rather than the 60 real ones. Use the glob, and expect 60 — 36 for
this schema's validator and 24 for `validate-layout.js` from issue #5. (Both
numbers were stated as 35/65 when this was written and have now gone stale three
times; if they disagree with what you see, trust the run, not the sentence.)
